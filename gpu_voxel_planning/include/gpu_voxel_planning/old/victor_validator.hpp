...
class VictorValidator : public ompl::base::StateValidityChecker,
 ...
 public:
  VictorValidator(const ompl::base::SpaceInformationPtr &si, GpuVoxelsVictor *victor_model);
  ~VictorValidator();
  ...
  std::shared_ptr<VictorValidator> getptr() { return shared_from_this(); }
...
class VictorConservativeValidator : public VictorValidator {
 public:
  VictorConservativeValidator(const ompl::base::SpaceInformationPtr &si, GpuVoxelsVictor *victor_model);
...
class VictorSampledWorldValidator : public VictorValidator {
 public:
  VictorSampledWorldValidator(const ompl::base::SpaceInformationPtr &si, GpuVoxelsVictor *victor_model);
...
class VictorStateThresholdValidator : public VictorValidator {
 public:
  VictorStateThresholdValidator(const ompl::base::SpaceInformationPtr &si, GpuVoxelsVictor *victor_model);
...
class VictorPathProbCol : public ompl::geometric::PathValidator {
 public:
  VictorPathProbCol(const ompl::base::SpaceInformationPtr &si, GpuVoxelsVictor *victor_model);
  virtual bool checkPath(const std::vector<ompl::base::State *> path, size_t &collision_index) override;

  virtual double getPathCost(const std::vector<ompl::base::State *> path, size_t &collision_index,
                             bool fast = false) override;

  virtual double getPathCost(const std::vector<ompl::base::State *> path, std::vector<double> &costs,
                             bool fast = false) override;
...
class VictorPathVox : public ompl::geometric::PathValidator {
 public:
  VictorPathVox(const ompl::base::SpaceInformationPtr &si, GpuVoxelsVictor *victor_model);
  virtual bool checkPath(const std::vector<ompl::base::State *> path, size_t &collision_index) override;
...
class VictorObjective : public ompl::base::OptimizationObjective {
 public:
  VictorObjective(const ompl::base::SpaceInformationPtr &si, std::shared_ptr<ompl::geometric::PathValidator> pv);
