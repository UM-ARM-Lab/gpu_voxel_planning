...
class VictorPlanner {
 public:
  ...
  virtual Maybe::Maybe<ompl::base::PathPtr> planPath(ompl::base::ScopedState<> start, Goals goals);
  ...
  Maybe::Maybe<PathUtils::Path> localControlConfig(VictorConfig start, VictorConfig goal);

  Maybe::Maybe<PathUtils::Path> localControlDouble(std::vector<double> start, std::vector<double> goal);

  virtual Maybe::Maybe<ompl::base::PathPtr> localControl(ompl::base::ScopedState<> start, Goals goal);

  virtual Maybe::Maybe<ompl::base::PathPtr> voxLocalControl(ompl::base::ScopedState<> start, Goals goals);

  ompl::base::PathPtr randomWiggle(ompl::base::ScopedState<> start);

  PathUtils::Path randomWiggleConfig(VictorConfig start);

  ompl::base::PathPtr iouWiggle(ompl::base::ScopedState<> start);

  PathUtils::Path iouWiggleConfig(VictorConfig start);

  double evaluateIouExploration(PathUtils::Path path);

 public:
  Maybe::Maybe<PathUtils::Path> planPathConfig(VictorConfig start, VictorConfig goal);

  Maybe::Maybe<PathUtils::Path> planPathDouble(std::vector<double> start, std::vector<double> goal);
...
class VictorLBKPiece : public VictorPlanner {
 public:
  ...
  virtual void preparePlanner(ompl::base::ScopedState<> start, Goals goals) override;
};
...
class VictorLazyRRTF : public VictorPlanner {
 public:
  ...
  virtual void initializePlanner() override;
  virtual Maybe::Maybe<ompl::base::PathPtr> planPath(ompl::base::ScopedState<> start, Goals goals) override;
  virtual void preparePlanner(ompl::base::ScopedState<> start, Goals goals) override;
...
class VictorThresholdRRTConnect : public VictorPlanner {
 public:
  VictorThresholdRRTConnect(GpuVoxelsVictor* victor_model, bool use_vox, bool use_prob_col);
  virtual void initializePlanner() override;
  virtual Maybe::Maybe<ompl::base::PathPtr> planPath(ompl::base::ScopedState<> start, Goals goals) override;
  virtual void preparePlanner(ompl::base::ScopedState<> start, Goals goals) override;

  virtual Maybe::Maybe<ompl::base::PathPtr> localControl(ompl::base::ScopedState<> start, Goals goals) override;
...
class VictorMotionCostRRTConnect : public VictorPlanner {
 public:
  ...
  Maybe::Maybe<ompl::base::PathPtr> planAnytime(ompl::base::ScopedState<> start, Goals goals);
  Maybe::Maybe<ompl::base::PathPtr> planUp(ompl::base::ScopedState<> start, Goals goals);
...
class VictorRRTStar : public VictorPlanner {
 public:
  VictorRRTStar(GpuVoxelsVictor* victor_model, bool use_prob_cost);
  virtual void initializePlanner() override;
  virtual void preparePlanner(ompl::base::ScopedState<> start, Goals goals) override;
  virtual Maybe::Maybe<ompl::base::PathPtr> planPath(ompl::base::ScopedState<> start, Goals goals) override;
