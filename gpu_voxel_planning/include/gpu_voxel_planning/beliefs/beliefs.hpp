...
namespace GVP {
    enum BeliefType {
        CHS, IID, Obstacle, Bonkers, MoEObstacle, MoEBonkers, Deterministic, ShapeCompletion
    };
 ...
 ********************************/
    ...
    public:
        ...
        MoEBelief(ChsBelief chsb, ObstacleBelief obsb) : expert_chs(std::move(chsb)),
                                                         expert_particle(std::move(obsb)) {}
