...
DistanceGrid::DistanceGrid()
    : gpu_voxels::voxelmap::DistanceVoxelMap(Vector3ui(GRID_X_DIM, GRID_Y_DIM, GRID_Z_DIM), VOXEL_SIDE_LENGTH,
                                             MT_DISTANCE_VOXELMAP),
...
void DistanceGrid::computeDistances() {
  parallelBanding3D(1, 1, 1, PBA_DEFAULT_M1_BLOCK_SIZE, PBA_DEFAULT_M2_BLOCK_SIZE, PBA_DEFAULT_M3_BLOCK_SIZE, 1);
