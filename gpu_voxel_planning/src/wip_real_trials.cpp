...
int main(int argc, char* argv[]) {
  ...
  ros::NodeHandle n;
  ros::ServiceClient video_recorder = n.serviceClient<arm_video_recorder::TriggerVideoRecording>("video_recorder");
  ...
  std::string filename = scenario.getName() + "_" + strat.getName() + "_" + scenario.belief_name + "_" +
