...
#include "gpu_voxel_planning/strategies/selective_densification_strategies.hpp"
...
getPrecomputedStrategyFactories()
{
    ...
    for(int i=0; i<10; i++)
    {
        ...
        // factories.push_back([i](){
        //         return std::make_shared<InflatedDenseGraphSearch>(true, 1000000, i);}); //not precomputed
